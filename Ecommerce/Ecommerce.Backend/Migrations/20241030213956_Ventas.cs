    ...
    public partial class Ventas : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VentasTemporal", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VentasTemporal_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VentasTemporal_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VentasTemporal_ProductoId",
                table: "VentasTemporal",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "IX_VentasTemporal_UsuarioId",
                table: "VentasTemporal",
                column: "UsuarioId");
        }
